...
BHV_MaxReading::BHV_MaxReading(IvPDomain domain) :
  IvPBehavior(domain)
{
...
bool BHV_MaxReading::setParam(string param, string val)
{
  param = tolower(param);
...
void BHV_MaxReading::onSetParamComplete()
{
}
...
void BHV_MaxReading::onHelmStart()
{
}
...
void BHV_MaxReading::onIdleState()
{
}
...
void BHV_MaxReading::onCompleteState()
{
}
...
void BHV_MaxReading::postConfigStatus()
{
}
...
void BHV_MaxReading::onIdleToRunState()
{
}
...
void BHV_MaxReading::onRunToIdleState()
{
}

bool BHV_MaxReading::updateHeading() {
  // Check that we have sensor readings
  ...
  m_best_delta_heading = sectorToAngle(m_sector_sensor_readings.size(), sector_ind);
  return(true);
}

bool BHV_MaxReading::processSensorReadings() {
...
IvPFunction* BHV_MaxReading::onRunState()
{
...
bool BHV_MaxReading::processHeading()
{
  bool ok = false;
